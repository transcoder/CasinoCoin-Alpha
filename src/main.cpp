...
// Copyright (c) 2013-2014 The CasinoCoin developers
...
uint256 hashGenesisBlock("0x4f46c9af6d88a14114b7dc53a37d81ba4064cda5ae2ede1213ca28fea9b86e9c");
static CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // CasinoCoin: starting difficulty is 1 / 2^12
...
{
    // CasinoCoin: IsDust() detection disabled, allows any valid dust to be relayed.
...
unsigned int static GetNextWorkRequired_V1(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // CasinoCoin: This fixes an issue where a 51% attack can change difficulty at will.
...
{
	static const int64 BlocksTargetSpacing = 1 * 30; // CasinoCoin: 30 seconds
...
{
    // CasinoCoin: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        // Genesis Block:
        // block.nTime = 1372621620
        // block.nNonce = 1022795
        // block.GetHash = e5d98005cd7744147b4c472fffc04a81bdc04756ddbcb49e6675f01b1585c1d3
        // CBlock(hash=e5d98005cd7744147b4c, PoW=00000ef9c997ddd28652, ver=1, hashPrevBlock=00000000000000000000, hashMerkleRoot=2ae9af367b, nTime=1372621620, nBits=1e0ffff0, nNonce=1022795, vtx=1)
        //  CTransaction(hash=2ae9af367b, ver=1, vin.size=1, vout.size=1, nLockTime=0)
        //    CTxIn(COutPoint(0000000000, -1), coinbase 04ffff001d0104474e592054696d65732032392f4a756e2f323031332045637561646f72204c6561646572205361797320426964656e2043616c6c65642048696d2041626f757420536e6f7764656e)
        //    CTxOut(error)
        //  vMerkleTree: 2ae9af367b

        // Testnet Genesis Block:
    	// 2014-02-09 14:28:11 block.nTime = 1391929777
    	// 2014-02-09 14:28:11 block.nNonce = 873544
    	// 2014-02-09 14:28:11 block.GetHash = 60cf36f96baf1c3d882c9f155ee3dfc3a1cb5a47071d797f606714db54f4b5e8
    	...
    	// 2014-02-09 14:28:11   CTransaction(hash=73d304deca65f150913c0f87305dec7aa3913919889e483aa04bda87133023e6, ver=1, vin.size=1, vout.size=1, nLockTime=0)
...
unsigned char pchMessageStart[4] = { 0xfa, 0xc3, 0xb6, 0xda }; // CasinoCoin
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CasinoCoinMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CasinoCoinMiner : ProcessBlock, block not accepted");
    }

    return true;
}

void static CasinoCoinMiner(CWallet *pwallet)
{
    printf("CasinoCoinMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("casinocoin-miner");
    ...
    {
        printf("CasinoCoinMiner terminated\n");
        throw;
    }
}
...
void GenerateBitcoins(bool fGenerate, CWallet* pwallet)
{
    ...
    for (int i = 0; i < nThreads; i++)
        minerThreads->create_thread(boost::bind(&CasinoCoinMiner, pwallet));
}
